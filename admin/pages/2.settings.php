    ...
    <div class="wpie-settings__main">
        ...
        <div class="wpie-field">
            <label class="wpie-field__label">
                <span class="screen-reader-text"><?php esc_html_e( 'Enter title here', 'buttons' ); ?></span>
                <input type="text" name="title" size="30" value="<?php echo esc_attr( $title ); ?>" id="title"
                       placeholder="<?php esc_attr_e( 'Add title', 'buttons' ); ?>">
            </label>
        </div>
        ...
        <details class="wpie-item is-builder"<?php echo esc_attr( $builder_open ); ?>>
            ...
            <summary class="wpie-item_heading"><h3><span class="dashicons dashicons-admin-customizer"></span>
                    <?php esc_html_e( 'Live preview', 'buttons' ); ?></h3>
            ...
            <div class="wpie-live-preview">
                ...
                <div class="wpie-buttons__group" id="wpie-builder"></div>
            </div>
