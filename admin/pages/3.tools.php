...
use WPButtons\Admin\ImporterExporter;
...
?>
    ...
    <div class="wpie-block-tool">
        ...
        <div class="inside">
            <h3><span class="dashicons dashicons-database-export"></span> <span><?php esc_html_e( 'Export Settings', 'wpiebutton' ); ?></span></h3>
            <div class="inside">
                <p><?php
        ...
        <div class="inside">
            <h3><span class="dashicons dashicons-database-import"></span> <span><?php esc_html_e( 'Import Settings', 'wpiebutton' ); ?></span></h3>
            <div class="inside">
                <p><?php
	                /* translators: %s: plugin name */
