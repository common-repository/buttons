...
class ImporterExporter {
	...
	public static function form_export(): void {
        ...
        <form method="post">
            ...
            <p>
				<?php
				submit_button( __( 'Export All Data', 'buttons' ), 'secondary', 'submit', false ); ?><?php
        ...
        <form method="post" enctype="multipart/form-data" action="">
            ...
            <p>
                <label>
					...
					<?php esc_html_e( 'Update item if item already exists.', 'buttons' ); ?>
                </label>
            ...
            <p>
				<?php
				submit_button( __( 'Import', 'buttons' ), 'secondary', 'submit', false ); ?><?php
